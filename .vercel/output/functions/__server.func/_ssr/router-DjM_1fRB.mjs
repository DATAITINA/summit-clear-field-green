...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DjM_1fRB.js
var router_DjM_1fRB_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-lto8XJZC.css";
var APP_NAME = "Stead";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "A quiet offline agent for showing up every day."
			}
		],
		links: [
			{
...
var $$splitComponentImporter = () => import("./routes-oSZXoq8u.mjs");
...
//#endregion
export { getRouter, router_DjM_1fRB_exports as t };
